...
**Regras:** Deve ser preenchido com a mesma informação do campo :link[#4 codIbge]{id=camada-transporte anchor=4-codibge}.
...
- Se for registro de [lotacaoFormPrincipal](#1-lotacaoformprincipal), deve ser preenchido com a mesma informação do campo :link[#3 cnesDadoSerializado]{id=camada-transporte anchor=3-cnesdadoserializado};
