...
**Regra:** Somente as CBOs apresentadas na :link[Tabela 7 - CBOs que podem registrar ficha de visita domiciliar e territorial]{id=grupo_cbo anchor=ficha-de-visita-domiciliar-e-territorial} podem ser adicionadas no campo CBO do profissional.
...
**Regra:** Quando preenchido, deverá ser informado o valor do campo :link[UUID origem da ficha de cadastro domiciliar]{id=dicionario-fcd anchor=11-uuidfichaoriginadora} pertencente à :link{id=dicionario-fcd}.
