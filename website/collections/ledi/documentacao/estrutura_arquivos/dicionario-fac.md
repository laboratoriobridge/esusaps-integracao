...
- Preencher somente um dos campos: :link[outraLocalidade]{id=dicionario-fac anchor=2-outralocalidade}, :link[inep]{id=dicionario-fac anchor=3-inep} ou :link[cnesLocalAtivade]{id=dicionario-fac anchor=12-cneslocalatividade};
- É de preenchimento obrigatório se :link[pseEducacao]{id=dicionario-fac anchor=18-pseeducacao} = `true` ou :link[pseSaude]{id=dicionario-fac anchor=19-psesaude} = `true`;
...
**Regra:** Não pode ser preenchido se :link[pseEducacao]{id=dicionario-fac anchor=18-pseeducacao} = `true` e :link[pseSaude]{id=dicionario-fac anchor=19-psesaude} = `false`.
...
- É de preenchimento obrigatório se :link[atividadeTipo]{id=dicionario-fac anchor=7-atividadetipo} for `1`, `2` ou `3`;
- Não pode ser preenchido se :link[atividadeTipo]{id=dicionario-fac anchor=7-atividadetipo} for `4`, `5`, `6` ou `7`;
- Não pode ser preenchido se :link[pseEducacao]{id=dicionario-fac anchor=18-pseeducacao} = `true` e :link[pseSaude]{id=dicionario-fac anchor=19-psesaude} = `false`.
...
* É de preenchimento obrigatório se :link[atividadeTipo]{id=dicionario-fac anchor=7-atividadetipo} for `4`, `5`, `6` ou `7`;
* Não pode ser preenchido se :link[atividadeTipo]{id=dicionario-fac anchor=7-atividadetipo} for `1`, `2` ou `3`.
...
**Regra:** É de preenchimento obrigatório se :link[atividadeTipo]{id=dicionario-fac anchor=7-atividadetipo} for `5` ou `6`.
...
**Regra:** Só pode ser preenchido se o campo :link[praticasEmSaude]{id=dicionario-fac anchor=17-praticasemsaude} possuir o valor `30`.
...
* Não pode ser preenchido se :link[atividadeTipo]{id=dicionario-fac anchor=7-atividadetipo} = `1`, `2` ou `3` e :link[temasParaReuniao]{id=dicionario-fac anchor=8-temasparareuniao} diferente de `Educação permanente`;
* É de preenchimento obrigatório se :link[atividadeTipo]{id=dicionario-fac anchor=7-atividadetipo} = `4`, `5` ou `7`;
- Se :link[temasParaSaude]{id=dicionario-fac anchor=16-temasparasaude} = `18 - Semana saúde na escola`, torna-se obrigatório o preenchimento de :link[pseEducacao]{id=dicionario-fac anchor=18-pseeducacao} ou :link[pseSaude]{id=dicionario-fac anchor=19-psesaude}.
...
- Se :link[pseEducacao]{id=dicionario-fac anchor=18-pseeducacao} = `true`, :link[inep]{id=dicionario-fac anchor=3-inep} torna-se obrigatório;
- Deve receber o valor `true` se :link[temasParaSaude]{id=dicionario-fac anchor=16-temasparasaude} = `18 - Semana saúde na escola` e :link[pseSaude]{id=dicionario-fac anchor=19-psesaude} = `false`.
- Se :link[pseEducacao]{id=dicionario-fac anchor=18-pseeducacao} = `true` e :link[pseSaude]{id=dicionario-fac anchor=19-psesaude} = `false`:
	- O grupo :link[profissionais]{id=dicionario-fac anchor=6-profissionais} não deve ser preenchido;
	- Os itens `01 - Reunião de equipe`, `02 - Reunião com outras equipes de saúde`, `03 - Reunião intersetorial / Conselho local de saúde / Controle social` e `05 - Atendimento em grupo` do campo :link[atividadeTipo]{id=dicionario-fac anchor=7-atividadetipo} não devem ser selecionados;
...
**Referência:** :link[Lista com todas as CBOs]{id=cbo}.
