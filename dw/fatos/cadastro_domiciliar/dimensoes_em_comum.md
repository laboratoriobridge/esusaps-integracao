...
| co\_dim\_tempo\_validade | Armazena a data de validade do cadastro de forma estruturada. Campo `co_seq_dim_tempo` da `tb_dim_tempo` |
| co\_dim\_tempo\_validade\_recusa | Armazena a data de validade em caso de recusa de cadastro. Campo `co_seq_dim_tempo` da `tb_dim_tempo` |
