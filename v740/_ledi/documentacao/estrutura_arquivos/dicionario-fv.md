...
- Deixa de ser obrigatório se o campo [cpfCidadao](#12-cpfcidadao) for preenchido.
...
- Deixa de ser obrigatório se o campo [cnsCidadao](#3-cnscidadao) for preenchido.
...
- Este campo deverá ser preenchido com o valor da coluna **Código e-SUS APS** da {% link dicionario#estrategiavacinacao, title: "tabela de referência" %}.
...
**Referência:** [Fabricante]({% url dicionario %}#fabricante).
...
**Referência:** [CBOs específicos]({% url dicionario %}#cboprescritor).
...
**Referência:** [Via de administração]({% url dicionario %}#viaadministracao-para-imunobiol-gicos).
...
- Se `Via de administração` = `Endovenosa`, o campo deve ser preenchido com o valor = `Rede venosa`;
- Se `Via de administração` = `Intramuscular` ou `Intramuscular Profunda`, o campo deve ser preenchido com um dos valores = `Vastolateral da coxa direito`, `Vastolateral da coxa esquerdo`, `Deltóide direito`, `Deltóide esquerdo`, `Dorso glúteo direito`, `Dorso glúteo esquerdo`, `Vastolateral da coxa direito`, `Vastolateral da coxa esquerdo`, `Ventro glúteo direito`, `Ventro glúteo esquerdo`, `Outro`;
...
**Referência:** [Local de aplicação]({% url dicionario %}#localaplicacao).
