...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2026-08-04")
public class IdentificacaoUsuarioCidadaoThrift implements org.apache.thrift.TBase<IdentificacaoUsuarioCidadaoThrift, IdentificacaoUsuarioCidadaoThrift._Fields>, java.io.Serializable, Cloneable, Comparable<IdentificacaoUsuarioCidadaoThrift> {
  ...
  private static final org.apache.thrift.protocol.TField ESTADO_CIVIL_FIELD_DESC = new org.apache.thrift.protocol.TField("estadoCivil", org.apache.thrift.protocol.TType.I64, (short)28);
  private static final org.apache.thrift.protocol.TField TIPO_SANGUINEO_FIELD_DESC = new org.apache.thrift.protocol.TField("tipoSanguineo", org.apache.thrift.protocol.TType.I64, (short)29);
  private static final org.apache.thrift.protocol.TField DNV_FIELD_DESC = new org.apache.thrift.protocol.TField("dnv", org.apache.thrift.protocol.TType.STRING, (short)30);
  private static final org.apache.thrift.protocol.TField ST_NAO_POSSUI_CPF_FIELD_DESC = new org.apache.thrift.protocol.TField("stNaoPossuiCpf", org.apache.thrift.protocol.TType.BOOL, (short)31);
  private static final org.apache.thrift.protocol.TField JUSTIFICATIVA_NAO_POSSUI_CPF_FIELD_DESC = new org.apache.thrift.protocol.TField("justificativaNaoPossuiCpf", org.apache.thrift.protocol.TType.I64, (short)32);
  ...
  private long estadoCivil; // optional
  private long tipoSanguineo; // optional
  private String dnv; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ESTADO_CIVIL((short)28, "estadoCivil"),
    TIPO_SANGUINEO((short)29, "tipoSanguineo"),
    DNV((short)30, "dnv"),
    ST_NAO_POSSUI_CPF((short)31, "stNaoPossuiCpf"),
    JUSTIFICATIVA_NAO_POSSUI_CPF((short)32, "justificativaNaoPossuiCpf");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 28: // ESTADO_CIVIL
          return ESTADO_CIVIL;
        case 29: // TIPO_SANGUINEO
          return TIPO_SANGUINEO;
        case 30: // DNV
          return DNV;
        case 31: // ST_NAO_POSSUI_CPF
          return ST_NAO_POSSUI_CPF;
        case 32: // JUSTIFICATIVA_NAO_POSSUI_CPF
  ...
  static {
    ...
    tmpMap.put(_Fields.CPF_RESPONSAVEL_FAMILIAR, new org.apache.thrift.meta_data.FieldMetaData("cpfResponsavelFamiliar", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.ESTADO_CIVIL, new org.apache.thrift.meta_data.FieldMetaData("estadoCivil", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.TIPO_SANGUINEO, new org.apache.thrift.meta_data.FieldMetaData("tipoSanguineo", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.DNV, new org.apache.thrift.meta_data.FieldMetaData("dnv", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public void clear() {
    ...
    setEstadoCivilIsSet(false);
    this.estadoCivil = 0;
    setTipoSanguineoIsSet(false);
  ...
  public void setEstadoCivil(long estadoCivil) {
    ...
    setEstadoCivilIsSet(true);
  }

  public void unsetEstadoCivil() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ESTADOCIVIL_ISSET_ID);
  }

  /** Returns true if field estadoCivil is set (has been assigned a value) and false otherwise */
  public boolean isSetEstadoCivil() {
    return EncodingUtils.testBit(__isset_bitfield, __ESTADOCIVIL_ISSET_ID);
  }

  public void setEstadoCivilIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ESTADOCIVIL_ISSET_ID, value);
  }

  public long getTipoSanguineo() {
    return this.tipoSanguineo;
  }

  public void setTipoSanguineo(long tipoSanguineo) {
    this.tipoSanguineo = tipoSanguineo;
    setTipoSanguineoIsSet(true);
  }

  public void unsetTipoSanguineo() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TIPOSANGUINEO_ISSET_ID);
  }
  ...
  public boolean isSetTipoSanguineo() {
    return EncodingUtils.testBit(__isset_bitfield, __TIPOSANGUINEO_ISSET_ID);
  }

  public void setTipoSanguineoIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TIPOSANGUINEO_ISSET_ID, value);
  }
  ...
  public void unsetDnv() {
    this.dnv = null;
  }

  /** Returns true if field dnv is set (has been assigned a value) and false otherwise */
  public boolean isSetDnv() {
    return this.dnv != null;
  }

  public void setDnvIsSet(boolean value) {
    if (!value) {
      this.dnv = null;
    }
  }
  ...
  public boolean equals(IdentificacaoUsuarioCidadaoThrift that) {
    ...
    boolean this_present_estadoCivil = true && this.isSetEstadoCivil();
    boolean that_present_estadoCivil = true && that.isSetEstadoCivil();
    if (this_present_estadoCivil || that_present_estadoCivil) {
      if (!(this_present_estadoCivil && that_present_estadoCivil))
        return false;
      if (this.estadoCivil != that.estadoCivil)
        return false;
    }
    ...
    if (this_present_tipoSanguineo || that_present_tipoSanguineo) {
      if (!(this_present_tipoSanguineo && that_present_tipoSanguineo))
        return false;
      if (this.tipoSanguineo != that.tipoSanguineo)
        return false;
    }

    boolean this_present_dnv = true && this.isSetDnv();
    boolean that_present_dnv = true && that.isSetDnv();
    if (this_present_dnv || that_present_dnv) {
      if (!(this_present_dnv && that_present_dnv))
        return false;
      if (!this.dnv.equals(that.dnv))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_estadoCivil = true && (isSetEstadoCivil());
    list.add(present_estadoCivil);
    if (present_estadoCivil)
      list.add(estadoCivil);

    boolean present_tipoSanguineo = true && (isSetTipoSanguineo());
    list.add(present_tipoSanguineo);
    if (present_tipoSanguineo)
      list.add(tipoSanguineo);

    boolean present_dnv = true && (isSetDnv());
    list.add(present_dnv);
    if (present_dnv)
      list.add(dnv);
  ...
  public int compareTo(IdentificacaoUsuarioCidadaoThrift other) {
    ...
    lastComparison = Boolean.valueOf(isSetEstadoCivil()).compareTo(other.isSetEstadoCivil());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEstadoCivil()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.estadoCivil, other.estadoCivil);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetTipoSanguineo()).compareTo(other.isSetTipoSanguineo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTipoSanguineo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.tipoSanguineo, other.tipoSanguineo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetDnv()).compareTo(other.isSetDnv());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDnv()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.dnv, other.dnv);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class IdentificacaoUsuarioCidadaoThriftStandardScheme extends StandardScheme<IdentificacaoUsuarioCidadaoThrift> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, IdentificacaoUsuarioCidadaoThrift struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 28: // ESTADO_CIVIL
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.estadoCivil = iprot.readI64();
              struct.setEstadoCivilIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 29: // TIPO_SANGUINEO
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.tipoSanguineo = iprot.readI64();
          ...
          case 30: // DNV
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.dnv = iprot.readString();
              struct.setDnvIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, IdentificacaoUsuarioCidadaoThrift struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetEstadoCivil()) {
        oprot.writeFieldBegin(ESTADO_CIVIL_FIELD_DESC);
        oprot.writeI64(struct.estadoCivil);
        oprot.writeFieldEnd();
      }
      if (struct.isSetTipoSanguineo()) {
        oprot.writeFieldBegin(TIPO_SANGUINEO_FIELD_DESC);
        oprot.writeI64(struct.tipoSanguineo);
        oprot.writeFieldEnd();
      }
      if (struct.dnv != null) {
        if (struct.isSetDnv()) {
          oprot.writeFieldBegin(DNV_FIELD_DESC);
          oprot.writeString(struct.dnv);
          oprot.writeFieldEnd();
        }
      }
