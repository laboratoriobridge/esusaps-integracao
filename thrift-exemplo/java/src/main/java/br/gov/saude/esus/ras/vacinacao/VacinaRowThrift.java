...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2026-08-19")
public class VacinaRowThrift implements org.apache.thrift.TBase<VacinaRowThrift, VacinaRowThrift._Fields>, java.io.Serializable, Cloneable, Comparable<VacinaRowThrift> {
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    VIA_ADMINISTRACAO((short)17, "viaAdministracao"),
    LOCAL_APLICACAO((short)18, "localAplicacao"),
    CO_RNDS_FABRICANTE((short)19, "coRndsFabricante");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 17: // VIA_ADMINISTRACAO
          return VIA_ADMINISTRACAO;
        case 18: // LOCAL_APLICACAO
          return LOCAL_APLICACAO;
        case 19: // CO_RNDS_FABRICANTE
          return CO_RNDS_FABRICANTE;
        default:
          return null;
      }
    }
  ...
  public long getLocalAplicacao() {
    return this.localAplicacao;
  }

  public void setLocalAplicacao(long localAplicacao) {
    this.localAplicacao = localAplicacao;
    setLocalAplicacaoIsSet(true);
  }

  public void unsetLocalAplicacao() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __LOCALAPLICACAO_ISSET_ID);
  }

  /** Returns true if field localAplicacao is set (has been assigned a value) and false otherwise */
  public boolean isSetLocalAplicacao() {
    return EncodingUtils.testBit(__isset_bitfield, __LOCALAPLICACAO_ISSET_ID);
  }

  public void setLocalAplicacaoIsSet(boolean value) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LOCAL_APLICACAO:
      if (value == null) {
        ...
        setLocalAplicacao((Long)value);
      }
      break;

    case CO_RNDS_FABRICANTE:
      if (value == null) {
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case LOCAL_APLICACAO:
      return getLocalAplicacao();

    case CO_RNDS_FABRICANTE:
      return getCoRndsFabricante();
  ...
  public boolean isSet(_Fields field) {
    ...
    case LOCAL_APLICACAO:
      return isSetLocalAplicacao();
    case CO_RNDS_FABRICANTE:
      return isSetCoRndsFabricante();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(VacinaRowThrift that) {
    ...
    boolean this_present_localAplicacao = true && this.isSetLocalAplicacao();
    boolean that_present_localAplicacao = true && that.isSetLocalAplicacao();
    if (this_present_localAplicacao || that_present_localAplicacao) {
      if (!(this_present_localAplicacao && that_present_localAplicacao))
        return false;
      if (this.localAplicacao != that.localAplicacao)
        return false;
    }

    boolean this_present_coRndsFabricante = true && this.isSetCoRndsFabricante();
    boolean that_present_coRndsFabricante = true && that.isSetCoRndsFabricante();
  ...
  public int hashCode() {
    ...
    boolean present_localAplicacao = true && (isSetLocalAplicacao());
    list.add(present_localAplicacao);
    if (present_localAplicacao)
      list.add(localAplicacao);

    boolean present_coRndsFabricante = true && (isSetCoRndsFabricante());
    list.add(present_coRndsFabricante);
    if (present_coRndsFabricante)
      list.add(coRndsFabricante);
  ...
  public int compareTo(VacinaRowThrift other) {
    ...
    lastComparison = Boolean.valueOf(isSetLocalAplicacao()).compareTo(other.isSetLocalAplicacao());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLocalAplicacao()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.localAplicacao, other.localAplicacao);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCoRndsFabricante()).compareTo(other.isSetCoRndsFabricante());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCoRndsFabricante()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.coRndsFabricante, other.coRndsFabricante);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetLocalAplicacao()) {
      if (!first) sb.append(", ");
      sb.append("localAplicacao:");
      sb.append(this.localAplicacao);
      first = false;
    }
    if (isSetCoRndsFabricante()) {
      if (!first) sb.append(", ");
  ...
  private static class VacinaRowThriftStandardScheme extends StandardScheme<VacinaRowThrift> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, VacinaRowThrift struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 18: // LOCAL_APLICACAO
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.localAplicacao = iprot.readI64();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, VacinaRowThrift struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetLocalAplicacao()) {
        oprot.writeFieldBegin(LOCAL_APLICACAO_FIELD_DESC);
